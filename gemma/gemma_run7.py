...
for batch_size in list_batch_size:
    for max_input_len in list_max_input_len: 
        build_command = f"trtllm-build --checkpoint_dir /workspace/TensorRT-LLM/examples/gemma/check/hf/7b/bf16 \
                            ...
                            --output_dir /workspace/TensorRT-LLM/examples/gemma/trt-engine/hf/7b/bf16"
        try:
            print(build_command)
...
--hf_model_dir /workspace/TensorRT-LLM/examples/gemma/gemma-7b \
--engine_dir /workspace/TensorRT-LLM/examples/gemma/trt-engine/hf/7b/bf16 \
--max_input_length 64 --max_ite 10 --batch_size 64 --output_len 32
"""